...
#define TEST_PIN  (1U << 4) //monitor context switch

static uint32_t volatile l_tickCtr;

void SysTick_Handler(void) {
    GPIOF_AHB->DATA_Bits[TEST_PIN] = TEST_PIN; //for context switch monitor
    ...
    GPIOF_AHB->DATA_Bits[TEST_PIN] = 0U; //context switch exits
}
